    ...
    <>
      ...
      <div className="px-2 pb-1 pt-1">
        ...
        <Link
          to={classPath}
          onClick={onNavigate}
          className="fa-press neo-raised flex min-h-touch items-center gap-2 rounded-lg bg-accent px-3 text-sm font-medium text-ink-inverse hover:bg-accent-hover"
        >
