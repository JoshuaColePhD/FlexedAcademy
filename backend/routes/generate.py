        ...
        try:
            ...
            if req.mode == "plan" and not req.voice:
                ...
                system_prompt += (
                    ...
                    "context, how they want the week to land). Accompany it with ONE brief colleague "
                    "line. The tappable cards are how they move; a paragraph of unsolicited modeling "
